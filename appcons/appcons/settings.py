"""
Django settings for appcons project.
...
SECRET_KEY = 'django-insecure-!fej7$2_tco-xne7hqp&%ceogepn@1!gcyktodn&pu1rdw3h@9'
...
WSGI_APPLICATION = 'appcons.wsgi.application'
